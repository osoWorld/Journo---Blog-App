...
import '../../../../../../widgets/common/buttons/main_button.dart';
import '../../../admin_dashboard.dart';

class AdminTagsModule extends StatefulWidget {
  const AdminTagsModule({super.key, required this.module});

  @override
  State<AdminTagsModule> createState() => _AdminTagsModuleState();
  final String module;
}

class _AdminTagsModuleState extends State<AdminTagsModule> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          widget.module == "Add" ? JText.addNewTags : JText.updateTags,
